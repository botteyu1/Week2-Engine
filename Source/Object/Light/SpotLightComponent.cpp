	...
	, ConeHeight(AttenuationRadius)
{
	...
	std::shared_ptr<UMesh> Mesh = UMesh::Create("SpotLightGuideMesh", "SpotLightGuideVertexBuffer", "SpotLightGuideIndexBuffer", emptySubMesh, D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
